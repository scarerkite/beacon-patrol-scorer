...
def detect_arrow_orientations(image_path):
    """
    Detect correct and incorrect arrow orientations on a Beacon Patrol board.
    ...
    """
    unique_correct_positions, unique_incorrect_positions, image = get_arrow_positions(image_path)
    ...
    for pt in unique_incorrect_positions:
    ...
    return len(unique_correct_positions), len(unique_incorrect_positions), result_image  # Return unique_incorrect count
